...
const WORKSPACE_ROOT = path.resolve(
  path.join(new URL(import.meta.resolve("@typeberry/tests/package.json")).pathname, "../../"),
);
...
async function main() {
  ...
  const results = new Map<TestName, { baseline: TestStats | null; current: TestStats | null }>();
